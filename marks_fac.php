            ...
            <div class="col-md-7 cs-reg-area">
             ...
             <form action="conf.php" method="post">
               ...
               <div class="form-group col-md-6">
                    <label>Select Subject to Post marks :</label>
               ...
               <form action="<?php cs_switch(); ?>" method="post">
                ...
                <?php
                 ...
                 <?php
                           ...
                           <?php if($result2 = mysqli_query($db, $sql)): ?>
                                ...
                                <?php if(mysqli_num_rows($result2) > 0): ?>
                                  ...
                                  <div class="cs-margin-bottom-30">
                                    ...
                                    <?php echo 'Post Marks for <b>' . $cname . ': </b>'; ?>
                                    ...
                                    <?php while($row2 = mysqli_fetch_array($result2)): ?>
                                      ...
                                      ?>
                                       <label class='col-md-3'><?php echo $row2['name'] ?> </label>
                                        ...
                                        <input type='text' class='col-md-4 form-control' onkeypress='return event.charCode >= 48 && event.charCode <= 57' name='<?php echo "marks_". $usr_val ?>'  maxlength = '6' placeholder='Enter Marks here'  > 
                                ...
                                $cc = $_COOKIE['c_id'];
                                  ...
                                  for ($n=0; $n <count($users) ; $n++) { 
                                   ...
                                   //}
                                    ...
                                    $user_check_query = "SELECT * FROM marks WHERE c_id='$cc' AND std_id='$users[$n]' LIMIT 1";
                                  ...
                                  $query = "INSERT INTO marks (c_id,std_id,emp_id,marks) VALUES('$cc','$users[$n]','$emp_id','$mm')";
                                  mysqli_query($db, $query);
                                   if(!$n > 0){ // SETTING LIMIT FTO PUSH ERROR ONCE
                                             array_push($err_f_s, "<strong>Marks</strong> Entered Successfully");
                                            //echo "Dupli";
                                          }else{
                                            continue;
                                          }
                                          ...
                                          if(!$n > 0){ // SETTING LIMIT FTO PUSH ERROR ONCE
                                             array_push($err_f_e, "<strong>Marks</strong> Already exists");
                                            //echo "Dupli";
                                          }else{
                                            continue;
                                          }
                      ...
                      <?php if(!$txt == 'conf.php'):?>
                      <button type="submit" name="post_marks" class="btn btn-primary cs-btn-color">Post Marks</button>
                    <?php endif; ?>
